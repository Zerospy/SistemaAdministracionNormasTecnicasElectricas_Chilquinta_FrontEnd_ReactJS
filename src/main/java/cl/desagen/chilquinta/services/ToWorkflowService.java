...
public class NormaService {
    ...
    public void publishNorma(Integer id) throws BusinessException {
        ...
        if (normaEntityOptional.isPresent()) {
            ...
            emailService.sendEmail(mailTo, String.format(mailToWorkflowSubject, normaEntity.getCodNorma()), String.format(mailToWorkflowBody, normaEntity.getCodNorma(), usuarioEntity.getFullName()));
    ...
    public DashboardDto getDashboardInformation() {
        ...
        Integer normasPublished = normaRepository.getNormasPublished(Long.valueOf(EstadoNorma.EN_REVISION.value));
