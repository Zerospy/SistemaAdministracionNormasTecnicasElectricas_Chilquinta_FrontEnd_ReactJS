    ...
    ExcelRenderer(fileObj, (err, resp) => {
      ...
      if (err) {
        ...
        if (newRows.length === 0) {
          ...
          this.setState({
              documento: "Documento cargado con exito",
      ...
      <NormasContext.Provider value={this}>
        ...
        <Row>
          <Col size="12">
            ...
            <label for="choose_file"><span id="file_name" className="btn btn-default" >Seleccione un documento</span>{this.state.documento}

                    <input type="file" name="choose_file" id="choose_file" onChange={this.fileHandler.bind(this)}
                     style={{ width: '0px' }} />
                  </label>
